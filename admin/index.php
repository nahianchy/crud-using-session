                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td><?= $key; ?></td>
                                    <td><a href="show.php?guestPosition=<?= $key; ?>"><?= $datum['full_name'] ?></a></td>
                                    <td>

                                      <a href="show.php?guestPosition=<?= $key; ?>"> Show |</a>

                                    <a href="edit.php?guestPosition=<?= $key; ?>"> Edit |</a>
                                    
                                    <a href="delete.php?guestPosition=<?= $key; ?>">Delete</a>
                                    </td>
                                </tr>
                            <?php
                            }
